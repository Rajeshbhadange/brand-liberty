    ...
    <div className="container-leads">
      <div className="boxs-leads">
        <div className="box leads-1">
          ...
          <div className="dm">
            <button className="menu-1" onClick={() => toggleDropdown("events")}>
              ☰
              <div className="dropdown">
                <a href="#Events" onClick={() => toggleDropdown("events")}></a>
        ...
        <div className="box leads-2">
          ...
          <div className="dm-2">
            <button className="menu-2" onClick={() => toggleDropdown("events")}>
              ☰
              <div className="dropdown">
                <a href="#Events" onClick={() => toggleDropdown("events")}></a>
